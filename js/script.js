...
const translations = {
    pt: {
        ...
        'iskor-statement': '"Professor, artista, pensador: Iskor representa uma geração que conecta a rua, sempre questionando quem somos e de onde viemos.<br><br>Siga o artista: @fe.iskor"',
        ...
        'milly-statement': '"Transformando lixo em arte, educação em ação: Milly é uma artista que salva oceanos com criatividade! Educadora por formação, artista por paixão: Milly prova que arte e consciência ambiental caminham juntas na construção de um planeta mais sustentável.<br><br>Siga o artista: @millypannunzio"',
        ...
        'rukin-statement': '"Rukin representa a síntese perfeita entre tradição artística e inovação contemporânea, transformando referências globais em narrativas poéticas que dialogam com o futuro.<br><br>Siga o artista: @rukin563"',
